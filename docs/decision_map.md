...
| You need to reduce prompt injection and unsafe outputs | Guardrails AI, NeMo Guardrails, LLM Guard, garak, PyRIT | Test and constrain input/output behavior |
| You need governance evidence | Model Card Toolkit, NIST AI RMF, AI Verify, Responsible AI Toolbox | Document system purpose, risk, fairness and controls |
